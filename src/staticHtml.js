...
<body class="bg-light">
    <div class="container">
        <div class="container mt-5">
            <h1 class="mb-4">Finca del Mar Monitoring Project</h1>
            <p>This site shows some of the status of my Tesla Powerwall system.</p>
            <p><a href="/battery" class="btn btn-primary">Battery Status</a> - View the current battery status and remaining hours at the current usage level.</p>
            <p><a href="/voltage" class="btn btn-primary">Voltage Data</a> - View the voltage data for the last hour.</p>

            <h2 class="mt-5">Using Cloudflare to monitor a Tesla Energy Gateway</h2>
            ...
            <h2 class="mt-5">Using Cloudflare and Aider</h2>
            ...
            see in <a href="/voltage" class="btn btn-primary">Voltage Data</a> page are collected every two minutes by a Cloudflare worker that logs into my TEG and grabs
